...
/**
 * ShipmentDetailMessage Class Doc Comment
 *
 * @category Class
 ...
 */
class ShipmentDetailMessage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ShipmentDetailMessage';
    ...
    protected static $openAPITypes = [
        ...
        'shippingDate' => 'string',
        'items' => '\OpenAPI\Client\Axro\Model\ShipmentDetailItem[]'
    ];
    ...
    {
        $this->setIfExists('orderNumbers', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['orderNumbers'] === null) {
            $invalidProperties[] = "'orderNumbers' can't be null";
        }
     ...
     * Sets orderNumbers
     *
     * @param string[] $orderNumbers orderNumbers
     *
     * @return self
     */
    public function setOrderNumbers($orderNumbers)
    {
        if (is_null($orderNumbers)) {
            throw new \InvalidArgumentException('non-nullable orderNumbers cannot be null');
        }
     ...
     * Gets items
     *
     * @return \OpenAPI\Client\Axro\Model\ShipmentDetailItem[]
     */
     ...
     * Sets items
     *
     * @param \OpenAPI\Client\Axro\Model\ShipmentDetailItem[] $items items
     *
     * @return self
     */
