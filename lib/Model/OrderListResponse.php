 ...
 *
 * @category Class
 * @description Simplified response model for the API endpoint.
 * @package  OpenAPI\Client\Axro
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class OrderListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'orders' => '\OpenAPI\Client\Axro\Model\OrderItem[]',
        'totalPages' => 'int'
    ];
    ...
    */
     ...
     * Gets orders
     *
     * @return \OpenAPI\Client\Axro\Model\OrderItem[]
     */
     ...
     * Sets orders
     *
     * @param \OpenAPI\Client\Axro\Model\OrderItem[] $orders orders
     *
     * @return self
     */
