...
class Order implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'cart' => '\OpenAPI\Client\Axro\Model\CartItem[]',
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['shippingAddressId'] === null) {
            $invalidProperties[] = "'shippingAddressId' can't be null";
        }
     ...
     *
     * @param string $shippingAddressId shippingAddressId
     *
     * @return self
     */
    public function setShippingAddressId($shippingAddressId)
    {
        if (is_null($shippingAddressId)) {
            throw new \InvalidArgumentException('non-nullable shippingAddressId cannot be null');
        }
     ...
     * Gets cart
     *
     * @return \OpenAPI\Client\Axro\Model\CartItem[]
     */
     ...
     * Sets cart
     *
     * @param \OpenAPI\Client\Axro\Model\CartItem[] $cart cart
     *
     * @return self
     */
