...
class SubscribeRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['apiToken']) < 1)) {
            $invalidProperties[] = "invalid value for 'apiToken', the character length must be bigger than or equal to 1.";
        }
     ...
     * Sets endpointUrl
     *
     * @param string $endpointUrl Customer webhook endpoint URL
     *
     * @return self
     */
     ...
     * Sets apiToken
     *
     * @param string $apiToken Token sent as X-API-Token and used for HMAC
     *
     * @return self
     */
    public function setApiToken($apiToken)
    {
        ...
        if ((mb_strlen($apiToken) < 1)) {
            throw new \InvalidArgumentException('invalid length for $apiToken when calling SubscribeRequest., must be bigger than or equal to 1.');
        }
