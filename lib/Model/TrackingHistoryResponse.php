...
/**
 * TrackingHistoryResponse Class Doc Comment
 *
 * @category Class
 * @description Simplified response model for tracking history endpoint.  Wraps the issues-service message in a stable envelope.
 * @package  OpenAPI\Client\Axro
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class TrackingHistoryResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TrackingHistoryResponse';
