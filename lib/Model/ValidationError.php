...
class ValidationError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'loc' => '\OpenAPI\Client\Axro\Model\ValidationErrorLocInner[]',
        'msg' => 'string',
        'type' => 'string'
    ];
    ...
    */
     ...
     * Gets loc
     *
     * @return \OpenAPI\Client\Axro\Model\ValidationErrorLocInner[]
     */
     ...
     * Sets loc
     *
     * @param \OpenAPI\Client\Axro\Model\ValidationErrorLocInner[] $loc loc
     *
     * @return self
     */
