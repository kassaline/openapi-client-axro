...
/**
 * ShipmentDetailItem Class Doc Comment
 *
 * @category Class
 * @description Individual item in a shipment.
 * @package  OpenAPI\Client\Axro
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ShipmentDetailItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ShipmentDetailItem';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['oemNumber'] === null) {
            $invalidProperties[] = "'oemNumber' can't be null";
        }
     ...
     * Sets oemNumber
     *
     * @param string $oemNumber oemNumber
     *
     * @return self
     */
    public function setOemNumber($oemNumber)
    {
        if (is_null($oemNumber)) {
            throw new \InvalidArgumentException('non-nullable oemNumber cannot be null');
        }
